...
% DOCUMENT LAYOUT
  ...
  \usepackage{geometry}
\geometry{nohead,left=0.6in,right=0.6in,bottom=0.4in,top=0.4in,footskip=5pt,letterpaper}
...
\pagestyle{fancy}
\rhead{}
%\chead{\ifthenelse{\value{page}=1}{}{Michael Sobrepera - Resume}}
\lhead{}
...
% ---- FILL IN HERE THE TITLE AND AUTHOR
    pdftitle={MichaelSobrepera-Resume},
