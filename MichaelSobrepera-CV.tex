...
PhD student and full stack roboticist with background in medical device design and manufacturing. Innovating at the intersection of robotics, rehabilitation, and telemedicine. Funded under an NIH F31 Pre-Doctoral Fellowship.
\end{minipage}

\begin{cvsection}{Education}

    \cvitem{Doctor of Philosophy in Mechanical Engineering}{University of Pennsylvania}{Philadelphia, PA}{Aug 2016}{Expected Dec 2021}{PhD student in Mechanical Engineering and Applied Mechanics (MEAM). Affiliated with the General Robotics, Automation, Sensing, \& Perception Laboratory (GRASP Lab).}
...
\begin{cvsection}{Skills}
    ...
    \cvitemshort{Robotics}{ROS, Kinematics, State Estimation, System Integration}{}
...
\begin{cvsection}{Publications}
    ...
    \printbibliography[title={Journal Publications},heading=subbibliography]
