...
\begin{cvsection}{Education}
    \cvitem{Doctor of Philosophy in Mechanical Engineering}{University of Pennsylvania}{Philadelphia, PA}{Aug 2016}{Expected Apr 2022}{PhD student in Mechanical Engineering and Applied Mechanics (MEAM). Adviser: Dr.\ Michelle Johnson, The Rehabilitation Robotics Laboratory. Affiliated with the General Robotics, Automation, Sensing, \& Perception Laboratory (GRASP lab).}
 %GPA: 3.28
...
\begin{cvsection}{Research Experience}
    ...
    Developing an affordable socially assistive robot to aid in telepresence based assessment and treatment of patients with upper extremity impairments as a tool to expand the reach of clinicians while improving the objectivity of diagnostic tools.
...
\begin{cvsection}{Teaching}
    ...
    \begin{cvsubsection}{Mentees}
        \cvmentee{Ralph Tamakloe}{Jun 2019}{Present}{Penn BioE Undergrad}{Freshman Summer}{Is working to understand how desktop social robots can be used for low cost, portable, objective upper extremity assesments}
