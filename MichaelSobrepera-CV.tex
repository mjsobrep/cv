...
\begin{cvsection}{Teaching}
    \begin{cvsubsection}{Teaching Assistantships}
        \cvitem{MEAM 147: Intro to Mechanics Lab}{University of Pennsylvania}{Philadelphia, PA}{Aug 2018}{Dec 2018}{Organized and ran the mechanics lab class for first semester undergraduate students in Mechanical Engineering and related fields, managing a team of 6. The class consisted of 41 students across 3 sections.}
    ...
    \begin{cvsubsection}{Mentees}
        \cvmentee{Dhruv Karthik}{Jan 2018}{Present}{Penn CIS Undergrad}{Freshman Fall}{Is working to build auto generated syntactic maps of hospitals to lower the barriers to entry of mobile robots in hospitals.}
        ...
        \cvmentee{Sabrina Smith}{July 2017}{Sept 2017}{Imperial College London Biomedical Engineering Undergrad}{idk}{Worked on alogrithims to convert outputs from human motion tracking systems to features which provide diagnostic information on upper extremity impairment}
