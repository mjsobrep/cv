...
Generalist problem solver and builder with deep technical expertise in robotics (hardware and software) and AI along with experience in product management and business strategy. 
\begin{itemize}
...
\begin{cvsection}{Experience}
    \cvitemtwojob{Project Leader}{Boston Consulting Group (BCG)}{Seattle, WA}{Aug 2024}{present}{
        \begin{itemize}
            ...
            \item Guided 10+ client organizations define an AI vision and AI strategy, through workshops with senior leadership, and to develop AI roadmaps and build plans, in coordination with technical leadership, enabling clients to rapidly move toward value capture from AI.
