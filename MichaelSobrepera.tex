...
\hspace*{\fill}\begin{minipage}{\textwidth-\cvindent}
    ...
    \\
    \\
    I have a unique background that combines deep technical skills and business acumen.
    ...
    Together, these skills allow me to enter new project spaces, rapidly gain domain knowledge, bring together the right people, and go deep to generate answers and solutions with real-world impact.
...
\begin{cvsection}{Skills}
    ...
    \cvitemshort{Programming Languages}{Python, R, C++, TypeScript, SQL}{}
...
\begin{cvsection}{Experience}
    \cvitem{Consultant}{Boston Consulting Group (BCG)}{Seattle, WA}{Apr 2022}{present}{
        \vspace{-0.2cm}
        \begin{itemize}
            \item Currently participating in the prestigious BCG Digital Rotation Program (DRP: staffing in various roles across BCG X for a year), as a developing leader in digital topics.
    ...
    \cvitem{Graduate Research Assistant}{University of Pennsylvania, Rehabilitation Robotics Laboratory}{Philadelphia, PA }{Aug 2016}{Apr 2022}{
        ...
        \begin{itemize}
            ...
            \item Led hardware design and software integration for the development of an affordable socially assistive robot (Flo) to aid in telepresence based assessment and treatment of patients with upper extremity motor impairments (\url{https://youtu.be/DDZe1RhcpWY}).
    ...
    \cvitemtwojob{Research Technician II}{Georgia Institute of Technology, IRIM Technology Transition Laboratory}{Atlanta, GA}{Dec 2015}{Jun 2016}{
        ...
        \begin{itemize}
            \item Redeveloped a C++ video based real-time textureless tracker from a research code base to a well documented robust system capable of running at \(30+\) fps at \(1920\times1080\) pixels, to enable manipulation on non-fixed, non-located car parts at a partner automotive facility.
