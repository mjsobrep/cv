...
I have prior research experience in computer vision for industrial automation.
Previously I focused on medical device design and manufacturing. 
...
\begin{cvsection}{Skills}
    ...
    \cvitemshort{Programming Languages}{Python, R, MATLAB, TypeScript, Arduino, LaTeX, SQL, C++}{}
...
\begin{cvsubsection}{Teaching Assistantships}
    ...
    \begin{cvsubsection}{Guest Lectures}
        ...
        \cvitemshort{Robots in Pediatric Rehabilitation}{Nov 2018}{Course: Bioengineering 514: Rehab Engineering and Design}
       ...
       % Lecture on Robotics in Pediatric Rehabilitation given to the \textit{Bioengineering 514: Rehab Engineering and Design} class at the University of Pennsylvania, including demos of systems, and a final group activity.}
        ...
        \cvitemshort{Robot Inspiration: Artificial Intelligence/Brain and Programming}{Mar 2018}{Course: Robots in HealthCare: From Science Fiction to Reality}
...
\begin{cvsection}{Talks}
    \cvitemshort{Penn MEAM Department Seminar}{Summer 2020}{The Design of Lil'Flo, a Socially Assistive Robot for Upper Extremity Motor Assessment and Rehabilitation Via Telepresence}
\end{cvsection}
...
\begin{cvsubsection}{Reviewer}
    ...
    \cvitemshort{International Conference on Robotics and Automation}{2017}{}
