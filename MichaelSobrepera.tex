...
\begin{cvsection}{Experience}
    \cvitemtwojob{Project Leader}{Boston Consulting Group (BCG)}{Seattle, WA}{Aug 2024}{present}{
        \vspace{-0.2cm}
        \begin{itemize}
            \item Leading product definition and go to market team for a GenAI tool.
            \item Led AI strategy workshops and subsequent engagements with several players across industries to help them crystalize an AI transformation vision, identify high-value use cases, scope use cases, develop roadmaps, and in select cases develop full workplans to execute.
    ...
    \cvitem{Graduate Research Assistant}{University of Pennsylvania, Rehabilitation Robotics Laboratory}{Philadelphia, PA }{Aug 2016}{Apr 2022}{
        ...
        \begin{itemize}
            ...
            \item Developed and deployed a remote robot teleoperation system (using TypeScript, Node.js, React, WebRTC, PostgreSQL, Nginx, Redis, Docker)
