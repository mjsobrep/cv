...
\begin{itemize}
    \item 7+ years designing, building, testing, and deploying complex AI enabled robotic systems for human interaction at the University of Pennsylvania and for manufacturing at The Georgia Institute of Technology.
    \item 3+ years delivering value to large organizations, with a focus on AI, as a management consultant, product manager, and engineer at the Boston Consulting Group (BCG).
    \item Proven record of leading teams, owning products, developing strategies, and managing complex stakeholder interactions.
\end{itemize}
    Seeking to apply breadth of expertise on a mission-driven team tackling challenging and impactful problems.
...
\begin{cvsection}{Experience}
    \cvitemtwojob{Project Leader}{Boston Consulting Group (BCG)}{Seattle, WA}{Aug 2024}{present}{
        \begin{itemize}
            \item Led 8-person cross-functional team driving upstream product, go-to-market, and stakeholder management for an agentic AI product; accelerated user testing, product iteration, and adoption to maximize value.
    ...
    \cvitemtwojob{NIH F31 Fellow}{University of Pennsylvania, Rehabilitation Robotics Laboratory}{Philadelphia, PA }{Apr 2020}{Apr 2022}{
        ...
        %\vspace{-0.2cm}
        \begin{itemize}
            \item Led end-to-end development (product definition, hardware design and fabrication, software development, and full system integration) for the development of an affordable, socially assistive, upper-humanoid robot to aid in telepresence-based assessment and treatment of patients with upper extremity motor impairments (\url{https://youtu.be/DDZe1RhcpWY}, \url{https://github.com/Rehab-Robotics-Lab/FloSystem}).
...
\end{cvsection}
 ...
 \begin{cvsection}{Highlighted Skills}
     ...
     \cvitemshort{Technical Software}{Python, R, Docker, Git, ROS, Computer Vision, System Integration, ML, HRI}{}

     \cvitemshort{Technical Hardware}{Mechatronics, MCAD, Technical Drawing, Classical+CNC Machining, Additive Manufacturing}{}
