...
\begin{cvsection}{Skills}
    ...
    \cvitemshort{Programming Languages}{Python, R, TypeScript, SQL}{}
...
\begin{cvsection}{Experience}
    \cvitem{Consultant}{Boston Consulting Group}{Seattle, WA}{Apr 2022}{present}{
        ...
        \begin{itemize}
            ...
            \item Product owner for major ecommerce re-build for a national multi-billion-dollar brand.
            \item Supported planning for a major global health initiative using data analytics (built in R) with a focus on analytical rigor and clear insight communication.
    ...
    \cvitem{Graduate Research Assistant}{University of Pennsylvania, Rehabilitation Robotics Laboratory}{Philadelphia, PA }{Aug 2016}{Apr 2022}{
        Socially Robot Augmented Telepresence for Rehabilitation
        \begin{itemize}
            ...
            \item Developed a prototype framework for identifying motor function from video of a patient doing various robot guided activities using both classical computer vision and machine learning techniques.
