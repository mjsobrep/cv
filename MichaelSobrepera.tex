...
\begin{cvsection}{Experience}
    \cvitemtwojob{Project Leader}{Boston Consulting Group (BCG)}{Seattle, WA}{Aug 2024}{present}{
        \vspace{-0.2cm}
        \begin{itemize}
            \item Led scaling and operations of the partnership with one of the hyperscalers, focused on together leveraging AI to transform clients' businesses.
            \item Led rapid build (as engineering lead) to develop a multi-agent survey analysis and interpretation system.
            \item Led upstream product, go-to-market, and stakeholder management for an agentic AI product in the professional services industry.
            \item Led AI strategy engagements with \textasciitilde10 clients. 
            \item Built a LLM based system to improve responses to ongoing infrastructure incidents using historical incident reports.
            \item Facilitated turnaround for a 15k+ person industrial site.
            \item Developed strategy for a services provider in the digital manufacturing space.
