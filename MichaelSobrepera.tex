...
I have an array of hard skills across design, hardware, software, and algorithms, complemented by strong data analysis, experimental design, team leadership, stakeholder management, and communication skills. This broad toolkit allows me to enter new project spaces, rapidly gain domain knowledge, go deep into problems, and manage complicated stakeholder dynamics to generate answers, solutions, and ultimately impact. 
...
I am passionate about learning, working on meaningful problems, pushing the boundaries of technology, and helping those around me to grow.  
...
\begin{cvsection}{Experience}
    \cvitemtwojob{Project Leader}{Boston Consulting Group (BCG)}{Seattle, WA}{Aug 2024}{present}{
        \vspace{-0.2cm}
        \begin{itemize}
            \item Leading the team driving the partnership for BCG with one of the hyperscalers, focused on leveraging AI to transform our clients' businesses --- managing pipeline, shaping deals, driving upskilling, engaging stakeholders, building the relationship, etc.
