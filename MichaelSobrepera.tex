...
\begin{cvsection}{Experience}
    \cvitemtwojob{Project Leader}{Boston Consulting Group (BCG)}{Seattle, WA}{Aug 2024}{present}{
        %%\vspace{-0.2cm}
        \begin{itemize}
            \item Led the team scaling and managing BCG's partnership with one of the hyperscalers, focused on together leveraging AI to transform clients' business. We managd a robust 100+ deal pipeline of opportunities globally, including opportunities where I defined the initial AI product to be delivered and AI architecture to be used. This work brought the two organizations closer, including bringing new joint offerings to the market.
    ...
    \cvitem{Graduate Research Assistant}{University of Pennsylvania, Rehabilitation Robotics Laboratory}{Philadelphia, PA }{Aug 2016}{Apr 2022}{
        ...
        %\vspace{-0.2cm}
        \begin{itemize}
            \item Led hardware design and fabrication, software development, and full system integration for the development of an affordable, socially assistive, upper-humanoid robot to aid in telepresence-based assessment and treatment of patients with upper extremity motor impairments (\url{https://youtu.be/DDZe1RhcpWY}, \url{https://github.com/Rehab-Robotics-Lab/FloSystem}).
