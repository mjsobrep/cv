...
Generalist problem solver and builder with deep technical expertise in robotics (hardware and software) and AI with experience in product management and business strategy. 
\begin{itemize}
    ...
    \item Proven record leading teams, owning products, developing strategies, and managing complex stakeholder interactions.
\end{itemize}
    Seeking to apply breadth of expertise to solve hard problems on a mission-driven team tackling technically challenging and socially impactful problems.
...
\begin{cvsection}{Experience}
    \cvitemtwojob{Project Leader}{Boston Consulting Group (BCG)}{Seattle, WA}{Aug 2024}{present}{
        \begin{itemize}
            \item Led 8-person cross-functional team driving upstream product, go-to-market, and stakeholder management for an agentic AI product; accelerated user testing, product iteration, and learning to maximize value.
            ...
            \item Guided senior clients to define an AI vision and AI strategy and worked with technical leadership to develop AI roadmaps and build plans across 10+ clients enabling clients to rapidly move toward value capture from AI.
            \item Built MVP AI products enabling non-technical users to query heterogeneous survey data and analyze incident reports for infrastructure operators.
...
\end{cvsection}
 ...
 \begin{cvsection}{Highlighted Skills}
     ...
     \cvitemshort{Technical}{Python, R, Docker, Git, ROS, Computer Vision, Kinematics, System Integration, Mechatronics, ML, HRI}{}
