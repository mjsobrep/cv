...
Generalist problem solver and builder with deep technical expertise in robotics (hardware and software) and AI and with experience in product management and business strategy. Seven years of experience designing, building, testing, and deploying complex robotic systems for human interaction at the University of Pennsylvania and manufacturing at The Georgia Institute of Technology, followed by three years as a management consultant, product manager, and engineer focussed on delivering value to large organizations. Proven track record leading teams, owning products, developing strategies, and managing complex stakeholder interactions, with a focus on delivering client value from modern AI/ML technologies. Seeking to contribute to a team tackling technically challenging and socially impactful problems, leveraging expertise across mechanical, software, and robotics engineering, product management, and business to advance mission-driven goals.
...
\begin{cvsection}{Experience}
    \cvitemtwojob{Project Leader}{Boston Consulting Group (BCG)}{Seattle, WA}{Aug 2024}{present}{
        %%\vspace{-0.2cm}
        \begin{itemize}
            \item Led upstream product, go-to-market, and stakeholder management team (8 members) for an agentic AI product, allowing the client to rapidly iterate  via user testing to maximize value from both the product and adoption enablement.
            ...
            \item Led the team (3 members) building BCG's partnership with a hyperscaler to mature a pipeline of AI and digital build opportunities, including acting as the expert to help BCG teams define the capability/product to be built.
            \item Guided senior clients to define an AI vision and AI strategy and worked with technical leadership to develop AI roadmap and build plans across >10 clients enabling clients to rapidly move towards AI builds.
            \item Led team (2 members) to build an AI product MVP to allow non-technical users to answer questions using large heterogeneous survey datasets.
            \item Built an AI product MVP for infrastructure operators to rapidly respond to incidents using prior incident reports.
            \item Rebuilt the leadership management system and core KPIs of a 15k+ person industrial facility to deliver a turn around which senior leaders described as the most important shift that they had ever experienced at the facility.
            \item Built a large scale data processing pipeline (in R) to target a large multi-million dollar global health investment with a clear focus on need, providing data to a large team of business consultants and client data scientists.
            \item Developed a strategy perspective in the climate and sustainabilty space through a combination of desk research and expert interviews which was leveraged widely to support clients on the climate journies.
    ...
    \cvitemtwojob{NIH F31 Fellow}{University of Pennsylvania, Rehabilitation Robotics Laboratory}{Philadelphia, PA }{Apr 2020}{Apr 2022}{
        ...
        %\vspace{-0.2cm}
        \begin{itemize}
            \item Led product definition, hardware design and fabrication, software development, and full system integration for the development of an affordable, socially assistive, upper-humanoid robot to aid in telepresence-based assessment and treatment of patients with upper extremity motor impairments (\url{https://youtu.be/DDZe1RhcpWY}, \url{https://github.com/Rehab-Robotics-Lab/FloSystem}).
            \item Studied patient interactions with telepresence systems which incorporate social robots and impacts on remote assessment and treatment.
    ...
    \cvitemtwojob{Research Technician II}{Georgia Institute of Technology, IRIM Technology Transition Laboratory}{Atlanta, GA}{Dec 2015}{Jun 2016}{
        ...
        %\vspace{-0.2cm}
        \begin{itemize}
            \item Translated a vision-based 3D object tracker from a research code base to a robust system capable of running reliably, in realtime, and at high resolution to enable robotic manipulation on non-fixed, non-located parts in manufacturing.
