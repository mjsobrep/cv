...
\begin{cvsection}{Experience}
    \cvitemtwojob{Project Leader}{Boston Consulting Group (BCG)}{Seattle, WA}{Aug 2024}{present}{
        %%\vspace{-0.2cm}
        \begin{itemize}
            \item Led product, go-to-market, and engineering teams in digital and AI builds across several sectors to drive client value. Included work defining the product to be built, designing the system architecture, implementing the system, testing the product in market, driving enablement, and iterating.
            \item Led the team building BCG's partnership with a hyperscaler to mature a pipelne of AI and digital build opportunities, including acting as the expert to help BCG teams define the capability/product to be built.
            \item Led strategy engagements with clients to define an AI vision and AI strategy with senior leadership and an AI roadmap and build plans with technical leadership.
            \item Worked to turn around a large 15k+ industrial facility.
            \item Developed strategies in the global health and climate and sustainability sectors.
    ...
    \cvitemtwojob{Research Technician II}{Georgia Institute of Technology, IRIM Technology Transition Laboratory}{Atlanta, GA}{Dec 2015}{Jun 2016}{
        ...
        %\vspace{-0.2cm}
        \begin{itemize}
            \item Translated a vision-based real-time textureless tracker from a research code base to a well documented robust system capable of running reliably at high resolution and frame rate with low latency to enable manipulation on non-fixed, non-located parts at a partner manufacturing facility.
