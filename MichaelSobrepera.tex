...
Robotics researcher, systems and software engineer, and business/product leader with  expertise in hardware/software system integration, mechanical design, AI-enabled robotic systems, and human robot interaction.
\begin{itemize}
    \item 7+ years developing complex robotic systems (hardware and software) from concept through deployment, including full-stack development of an upper-humanoid social robot (mechanical design,  control, sensor integration, computer vision,  social human interaction, and system-level integration) at the University of Pennsylvania and vision-based tracking and control systems for industrial manufacturing at The Georgia Institute of Technology.
    \item 3+ years driving strategy, product development, and operations transformations with a focus on AI at the Boston Consulting Group (BCG), leading cross-functional teams with hands-on experience building and deploying ML systems.
...
\begin{cvsection}{Education}
    ...
    \cvitem{Doctor of Philosophy in Mechanical Engineering}{University of Pennsylvania}{Philadelphia, PA}{Aug 2016}{Apr 2022}{Advisor: Dr.\ Michelle Johnson \\
...
\begin{cvsection}{Experience}
    \cvitemtwojob{Project Leader}{Boston Consulting Group (BCG)}{Seattle, WA}{Aug 2024}{present}{
        \begin{itemize}
            \item Led 8-person cross-functional team driving product, go-to-market, and stakeholder management for an agentic AI product; accelerated user testing, product iteration, and adoption to maximize value.
            %\item Led product and upstream go-to-market, and engineering teams in digital and AI builds across several sectors to drive client value. Included work defining the product to be built, designing the system architecture, implementing the system, testing the product in market, driving enablement, and iterating.
            \item Led 3-person team building BCG's partnership with a hyperscaler to mature a pipeline of AI and digital build opportunities, including acting as the expert to help BCG teams define the capability/product to be built.
            \item Guided 10+ client organizations to define an AI vision and AI strategy, through workshops with senior leadership, and to develop AI roadmaps and build plans, in coordination with technical leadership, enabling clients to rapidly move toward value capture from AI.
            \item Built MVP AI products enabling non-technical users to query heterogeneous survey data to improve strategic decision making and analyze incident reports to respond to infrastructure failures.
            \item Redesigned and implemented the leadership management system and core KPIs of a 15k+ person industrial facility to deliver a turnaround which leadership described as the most impactful shift in a generation.
            \item Built a large-scale data processing pipeline (in R) to target a multi-million dollar global health investment with a clear focus on need, providing data to a large team of business consultants and client data scientists.
            %\item Developed a strategy perspective in the climate and sustainability space through a combination of desk research and expert interviews which was leveraged widely to support clients on their climate journeys.
            %\item Led the team scaling BCG's partnership with one of the hyperscalers, focused on together leveraging AI to transform clients' business, with a robust 100+ opportunity pipeline globally built on several joint offerings, co-marketing, etc. For the most mature opportunities, I worked with clients and our teams to define the initial AI product/capability to be delivered and architecture to be used.
            %\item Led rapid build (as engineering lead) to develop a multi-agent survey analysis and interpretation system which demonstrated the ability of LLMs to democratize access to large datasets.
            %\item Led upstream product, go-to-market, and stakeholder management teams for an agentic AI product in the professional services industry. Through interactions with users, we defined user needs, interfaced with product designers to develop designs, worked with 3rd party data and solution providers to define data sources and workflows, and worked with engineering to define final product. We then rapidly tested the product in full production pilots allowing us to drive product iteration while also developing frameworks for organizational transformation with AI. Additionally I directly managed senior leadership to shepherd the program towards positive outcomes. 
            %\item Led AI strategy engagements with \textasciitilde10 clients. Through a series of meetings and workshops, I helped senior technical and non-technical leadership at clients to develop an initial vision for how their organization could transform with the help of AI. I then worked with client technical teams to build a road map and detailed build plan for the first phase of the road map.
            %\item Built a LLM based system to improve responses to ongoing infrastructure incidents using historical incident reports for large infrastructure operators.
            %\item Facilitated turnaround for a 15k+ person industrial site through engagement across senior leadership to develop a new operating model built on common metrics and practices, leading to a restoration in communications, processes, and confidence among both the site leadership and offsite organization leadership. 
            %\item Developed the strategy for a services provider in the digital manufacturing space to be able to support clients from digital manufacturing strategy development through pilot production with advanced automation.
            %\item Owned product for e-commerce site re-build for a national multi-billion-dollar brand.
            %\item Led data analysis and reporting to develop strategy allocating \$100's MM for a global health initiative.
            %\item Developed a topical POV on a key climate and sustainability topic to guide strategies for major industrial companies.
            %\item Supported the spin-out of a climate tech company from a larger corporation.
        \end{itemize}
    }{Consultant}{Apr 2022}{Aug 2024}

    \cvitemtwojob{NIH F31 Fellow}{University of Pennsylvania, Rehabilitation Robotics Laboratory}{Philadelphia, PA }{Apr 2020}{Apr 2022}{
        % Social Robot Augmented Telepresence for Rehabilitation
        %\vspace{-0.2cm}
        \begin{itemize}
            \item Led complete system design and integration of an affordable social rehab robot (upper-humanoid) for telerehabilitation: designed mechanical structure and actuator integration, developed motor control and feedback algorithms, integrated sensors (incl. RGBD cameras), performed full system integration, developed teleop and semi-autonomy capabilities, developed human/robot behavior system, and drove testing (\url{https://youtu.be/DDZe1RhcpWY}, \url{https://github.com/Rehab-Robotics-Lab/FloSystem}).
            \item Studied patient interactions with telepresence systems which incorporate social robots and impacts on remote assessment and treatment after stroke, cerebral palsy, etc.
        ...
        \end{itemize}
    }{Graduate Research Assistant}{Aug 2016}{Apr 2022}
    ...
    \cvitemtwojob{Research Technician II}{Georgia Institute of Technology, IRIM Technology Transition Laboratory}{Atlanta, GA}{Dec 2015}{Jun 2016}{
        ...
        %\vspace{-0.2cm}
        \begin{itemize}
            \item Translated a vision-based 3D object tracker from a research code base to a robust system capable of running reliably, in real-time, and at high resolution to enable robotic manipulation on non-fixed, non-located parts in manufacturing.
            \item Developed and validated perception and control systems for industrial manufacturing applications, working with heavy industrial robots and optimizing for real-time performance and reliability in production environments.
            ...
            \item Integrated perception and motion control to track moving targets with collaborative robots using vision guidance.
        \end{itemize}
    ...
    \cvitem{Automation Intern}{Eli Lilly and Company}{Indianapolis, IN}{May 2015}{Aug 2015}{
        ...
        \begin{itemize}
            ...
            \item Developed strategy for offline software/hardware/operator-in-the-loop plant simulations (digital twins) for process validation, control code development, control system checkout, operator training, and process improvement.
        \end{itemize}}

    \cvitem{Machine Shop Supervisor}{Georgia Institute of Technology, TEP Machine Shop}{Atlanta, GA}{Aug 2014}{May 2015}{
        %\vspace{-0.2cm}
        \begin{itemize}
            \item Maintained shop, ensuring availability and safety of equipment.
            \item Guided Master's in Biomedical Innovation and Development students in designing and prototyping of medical devices.
            \item Supported cardiovascular research labs in development and fabrication of experimental equipment.
        \end{itemize}
    }
    ...
    \cvitem{Product Development Engineering Co-Op}{Unilife Corporation}{York/King of Prussia, PA}{Jan 2014}{Jul 2014}{
        %\vspace{-0.2cm}
        \begin{itemize}
            \item Developed, prototyped, and tested new injectable drug delivery device product concepts.
            \item Designed and integrated automation equipment for syringe component gluing, assembly, and finish operations.
        \end{itemize}
...
\end{cvsection}
 ...
 \begin{cvsection}{Highlighted Skills}

     \cvitemshort{Robotics Engineering}{HRI, System and Sensor Integration, ROS, Computer Vision, Planning \& Control}{}

     \cvitemshort{Software Engineering}{Python, C++, R, Docker, Git, ML/AI Integration}{}

     \cvitemshort{Mechanical Engineering}{Product Design, Mechatronics, MCAD (SolidWorks), Prototype and Scale Manufacturing}{}

     \cvitemshort{Product \& Strategy}{Product Discovery, Roadmapping, Feature Definition, Go-To-Market, Stakeholder Management}{}

     %\cvitemshort{Software Development}{\emph{Languages:} Python, R | \emph{Tooling:} Docker, Git}{}
     ...
     %\cvitemshort{Machine Learning}{Classical techniques (regression, clustering, SVD, \ldots), CNNs, DNNs, GANs, applied LLMs}{}

     %\cvitemshort{Software Infrastructure}{Docker, Git, NGINX, Node.js, Redis, PostgreSQL, React}{}

     %\cvitemshort{General Business}{Team Leadership, Stakeholder Management, Storytelling, Strategy Development}{}

     %\cvitemshort{Product}{Product Discovery, Roadmap Development, Feature Definition, GTM}{}

 \end{cvsection}
\begin{cvsection}{Publications}

    \newrefsection
    \nocite{sobrepera2025AgeMotorFunctionCognitive,
    ...
    \newrefsection
    \nocite{sobrepera2022TherapistsOpinionsTelehealth,
    ...
    %\newrefsegment
    %\printbibliography[title={Preprints}, heading=subbibliography,segment=\therefsegment]
    ...
    \begin{taggedblock}{conference-abstracts}
        ...
        \printbibliography[title={Extended Conference Abstracts with Poster Presentations},heading=subbibliography,segment=\therefsegment]
    \end{taggedblock}
...
%    \cvitemshort{University of Pennsylvania Fontaine Fellowship}{Sept 2016 -- Apr 2020}{}
 ...
 \begin{taggedblock}{ventures}
\begin{cvsection}{Ventures}

    \cvitem{MAR Orthotics}{Co-Founder \& President}{Philadelphia, PA}{Oct 2019}{Feb 2021}{
        Novel Orthoses for Pediatric Cerebral Palsy
        \begin{itemize}
            \item Performed customer discovery and validation to refine product market fit.
            \item Pitched in Penn Wharton Entrepreneurship Startup Challenge and won Innovation Award.
            \item Pitched in Rothberg Catalyzer (med tech startup challenge) and won overall first place award.
        \end{itemize}
    }
